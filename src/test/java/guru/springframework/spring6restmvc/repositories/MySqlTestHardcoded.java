...
public class MySqlTestHardcoded {

    @Container
    // using 8.0 because 9th version doesn't recognize a parameter -- gives error
    ...
    // @ServiceConnection --automatic overriding these properties
